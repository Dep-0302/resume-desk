...
- Installation and first-use tasks follow docs/INSTALL.md. Do not run QA fixtures or GUI regressions as a substitute for connecting the user's real records.
- Tests use temporary synthetic data, never personal queues.
- Keep shipped capabilities separate from docs/ROADMAP.md. Do not claim the planned installer, Skill/plugin, bundled runtime or setup wizard already exists.
